...
3. In `R`, use the following `devtools` command to install the Epi786FirstRound package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
  ...
  options(andromedaTempFolder = "c:/andromedaTemp")
	...
	outputFolder <- "c:/Epi786FirstRound"
...
License
=======
The Epi786FirstRound package is licensed under Apache License 2.0

Development
===========
Epi786FirstRound was developed in ATLAS and R Studio.
