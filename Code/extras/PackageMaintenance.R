...
OhdsiRTools::checkUsagePackage("Epi786FirstRound")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/Epi786FirstRound.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Epi786FirstRound.pdf")
...
OhdsiRTools::createRenvLockFile("Epi786FirstRound")
